...
<html lang="en">
  ...
  <body>
    <br />
    <h1 style="margin-left: 50px">Tambah Data</h1>
    <br />
    <br>
...
<div class="row g-3 align-items-center" style="margin-left: 50px;">
  <div class="col-2">
    <label for="telepon" class="col-form-label">NomorTelepon :</label>
  </div>
  <div class="col-auto">
    <input type="text" id="telepon" name="telp" class="form-control">
  </div>
</div><br>
